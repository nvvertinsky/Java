...
### Как ослаблять связанность между модулями.: 
  ...
  - Интерфейсы. Фасад. 
	...
	- Модули должны взаимодействовать друг с другом лишь посредством интерфейсов. За реализацию интерфейса подсистемы может отвечать специальный объект фасад.
